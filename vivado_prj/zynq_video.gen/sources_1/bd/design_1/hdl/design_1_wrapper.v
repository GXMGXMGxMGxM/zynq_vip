...
module design_1_wrapper
  ...
  output hdmi_out_tmds_clk_n;
  output hdmi_out_tmds_clk_p;
  output [2:0]hdmi_out_tmds_data_n;
  output [2:0]hdmi_out_tmds_data_p;
  ...
  wire hdmi_out_tmds_clk_n;
  wire hdmi_out_tmds_clk_p;
  wire [2:0]hdmi_out_tmds_data_n;
  wire [2:0]hdmi_out_tmds_data_p;
  ...
  design_1 design_1_i
       (.DDR_addr(DDR_addr),
        ...
        .hdmi_out_tmds_data_n(hdmi_out_tmds_data_n),
        .hdmi_out_tmds_data_p(hdmi_out_tmds_data_p));
